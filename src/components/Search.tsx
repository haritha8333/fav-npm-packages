...
const Search: React.FC = () => {
  ...
  const handleAddToFavorites = (packageName: string) => {
    ...
    setError(null); 
    // Reset the error state when starting the action
  };
  ...
  return (
    <div className="min-h-screen bg-ash-200">
      <div className="container mx-auto p-4 md:p-8">
        ...
        <div className="flex flex-col md:flex-row items-stretch justify-between mb-4 md:mb-8">
          ...
          <button
            ...
            className="p-4 bg-blue-800 text-white rounded w-full md:w-auto text-center"
          >
            Search
          </button>
        </div>
        ...
        <ul className="list-none p-0">
          {searchResults.map((result) => (
            <li key={result.package.name} className="mb-4">
              <div className="bg-white-100 p-4 rounded shadow-md  justify-between items-center">
                <div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div className="bg-white p-8 rounded shadow-md">
              ...
              <input
                ...
                className="p-2 border rounded w-full mb-4 bg-blue-100"
              />
              <div className="flex justify-end">
                <button
                  onClick={() => setAddingToFavorites(null)}
                  className="p-2 bg-red-400 text-white  mr-2"
                >
                  Cancel
                </button>
                <button
